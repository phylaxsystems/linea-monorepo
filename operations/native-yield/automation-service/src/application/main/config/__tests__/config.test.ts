...
const TEST_LINETH_ROLLUP_ADDRESS = "0x1111111111111111111111111111111111111111";
...
const createValidEnv = () => ({
  ...
  LINETH_ROLLUP_ADDRESS: TEST_LINETH_ROLLUP_ADDRESS,
...
describe("toClientConfig", () => {
  it("maps validated environment to bootstrap config", () => {
    ...
    expect(config).toMatchObject({
      ...
      contractAddresses: {
        linethRollupContractAddress: expect.any(String),
