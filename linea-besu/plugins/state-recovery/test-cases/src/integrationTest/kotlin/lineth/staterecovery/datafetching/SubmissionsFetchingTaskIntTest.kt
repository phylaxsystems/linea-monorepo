...
class SubmissionsFetchingTaskIntTest {
  ...
  fun beforeEach(vertx: Vertx) {
    ...
    configureLoggers(
      ...
      "lineth.staterecovery.BlobDecompressorToDomainV1" to Level.DEBUG,
      "lineth.plugin.staterecovery.clients" to Level.DEBUG,
      "test.clients.l1.web3j-default" to Level.INFO,
      "test.clients.l1.web3j.receipt-poller" to Level.INFO,
      "lineth.staterecovery.datafetching" to Level.INFO,
    )
