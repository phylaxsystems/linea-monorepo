...
open class TestRunner(
  ...
  init {
    configureLoggers(
      ...
      "lineth.staterecovery" to Level.TRACE,
      "lineth.plugin.staterecovery" to Level.INFO,
      "lineth.plugin.staterecovery.clients.l1.blob-scan" to Level.TRACE,
      "lineth.plugin.staterecovery.clients.l1.logs-searcher" to Level.INFO,
    )
  }
