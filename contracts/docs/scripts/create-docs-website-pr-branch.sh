...
# The new PR branch will contain autogenerated smart contract documentation for the Lineth monorepo
...
DOCS_REPO_PR_BRANCH_NAME=update-lineth-smart-contract-docs
DOCS_REPO_PR_COMMIT_MESSAGE="Update Lineth smart contract docs"
