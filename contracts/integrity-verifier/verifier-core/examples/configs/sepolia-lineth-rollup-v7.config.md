# LinethRollup V7 Upgrade Verification - Sepolia

This configuration verifies the LinethRollup V7 upgrade deployed on Sepolia.
...
isProxy: true
ozVersion: v4
schema: ../schemas/lineth-rollup.json
```
...
pnpm build
node dist/cli.mjs -c ../verifier-core/examples/configs/sepolia-lineth-rollup-v7.config.md -v
```
