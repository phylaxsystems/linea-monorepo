...
Solidity smart contracts for the Lineth protocol: L1 rollup (LinethRollup), messaging services (L1/L2MessageService), token bridge (TokenBridge), and supporting libraries. Built with Hardhat and Foundry.
